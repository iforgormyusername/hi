    ...
    <>
      ...
      <div className={styles.topnav}>
        ...
        <div className={styles.navlinks}>
          ...
          <a href="https://sus.app25.repl.co" target="_blank">Proxy</a>
        </div>
      </div>
      <main className={styles.main}>
        ...
        <div className={styles.center}>
          ...
          <div className={styles.footer}>
            <p>Powered by <a href="https://openai.com/" target="_blank">OpenAI</a>. Built by a <a href="https://replit.com/@app25/" target="_blank">Pro Fortniter</a>.</p>
          </div>
        </div>
      </main>
    </>
